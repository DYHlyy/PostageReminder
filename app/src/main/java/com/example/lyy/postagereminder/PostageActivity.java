...
public class PostageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int postageImageId = intent.getIntExtra(POSTAGE_IMAGE_ID, 0);
        ...
        Glide.with(this).load(postageImageId).into(fruitImageView);
        String fruitContent = generatePostageContent(postageName);
